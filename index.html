...
<head>
    ...
    <style>
        * {
        ...
        /* Таблица - адаптация с горизонтальным скроллом */
        .table-wrapper {
            overflow-x: auto;
            border-radius: 15px;
            border: 1px solid #e2e8f0;
...
<div class="container">
    ...
    <div class="filter-bar">
        ...
        <div class="filter-section">
            ...
            <div class="checkbox-group">
                ...
                <label class="checkbox-item">
                    <input type="checkbox" id="oilSoon"> Скоро замена
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="footer-note">
        * ID в формате K-. "Скоро замена" - 330 дней от даты приезда
    </div>
</div>
            ...
            if (filtered.length === 0) {
                ...
                filtered.forEach(record => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="actions">
                            <button class="edit-btn" data-id="${escapeHtml(record.id)}" title="Ред.">✏️</button>
                            <button class="delete-btn" data-id="${escapeHtml(record.id)}" title="Уд.">🗑️</button>
                        </td>
                    `;
